...
class liqui (Exchange):
    ...
    async def fetch_markets_from_cache(self):
        markets = await self.cacheapiGetPairs()
        result = []
    ...
    async def fetch_currencies_from_cache(self, params={}):
        currencies = await self.cacheapiGetCurrencies(params)
        result = {}
    ...
    async def fetch_balance_from_web(self, params={}):
        ...
        balances = await self.webGetUserBalances(params)
